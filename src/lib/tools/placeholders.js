...
export const placeholderArticle = {
    ...
    image: "https://cdn.mos.cms.futurecdn.net/74iTD8HJ5sqkEyzWXwMQNi-970-80.jpg.webp",
    perex:"Men might grow a beard or maintain a mustache just for extra style points, but the facial hair of the cat has nothing to do with fashion. A cat's whiskers — or vibrissae — are a well-honed sensory tool that helps a cat see in the dark and steer clear of hungry predators.",
    ...
    date: new Date("March 19, 2014"),
    comments: [placeholderComment,placeholderComment],
    votes: 300


}
export const placeholderArticleArray = [
    placeholderArticle, placeholderArticle
]